...
\date{Presentation to the North Essex Astronomical Society \\ 20 November 2019 \\ Find the presentation at \alert{\url{https://tinyurl.com/y7w542eb}}}
...
\insertpicturewithcredit{11-0222-13D.jpg}{angle=-90,origin=c,scale=0.3}{black}{Reidar Hahn, Fermilab}{-4}{-3}



% From https://www.darkenergysurvey.org/multimedia/photo-gallery/
\insertpicturewithcredit{11-0200-15D.jpg}{scale=0.40}{black}{Reidar Hahn, Fermilab}{-3.5}{-3.6}
...
\insertpicturewithcredit{12-0332-18D.jpg}{scale=0.4}{black}{Fermilab}{-3.5}{-3.6}
...
\insertpicturewithcredit{DECam-overview.png}{scale=0.75}{black}{arxiv.org 1111.4717}{-3.5}{-3.6}
...
\insertpicturewithcredit{dr1_bandpass.jpg}{scale=0.27}{white}{www.ctio.noao.edu}{-3}{3.5}
...
\insertpicturewithcredit{12-0328-26D.jpg}{scale=0.35}{black}{Reidar Hahn, Fermilab}{-3}{-3.6}

% Telescope from inside
% From DES Fermilab Gallery at http://vms.fnal.gov/stillphotos/2012/0300/12-0331-04D.jpg
\insertpicturewithcredit{12-0331-04D.jpg}{scale=0.4}{black}{Fermilab}{-3.5}{-3.6}
...
\insertpicturewithcredit{des0303-3540-spiral.jpg}{scale=0.28}{black}{Erin Sheldon, DES}{-3}{-4}


\begin{frame}{Dark Energy Survey}
  \begin{block}{}
    \begin{itemize}
      \item{The camera has been used as part of a survey to collect information about the locations of many distant galaxies.}
...
\begin{frame}{Dark Energy Survey}
  \begin{block}{}
    \begin{itemize}
      \item{Survey lasts six years - final year has recently ended.}
...
% Abell 2744
\insertpicturewithcredit{_STScI-gallery-1401a-480x630.jpg}{scale=0.5,angle=-90,origin=c,}{black}{Hubble Frontier Fields}{0}{-3.6}
...
\begin{frame}{Clustering}
  \begin{block}{}
    \begin{itemize}
      ...
      \item{The idea to look at clustering is due to Jim Peebles (Nobel prize in physics 2019).}
    \end{itemize}
  \end{block}
\end{frame}
...
\insertpicturewithcredit{party.jpg}{scale=0.55}{black}{www.kingsnews.org}{-2.5}{-3}
...
\begin{frame}{Exercise answers}
  \begin{table}
    \begin{tabular}{| c | c | c | }
    Bin & Data Count & Random Count\\
    \hline
    0 - 50 & 7 & 3 \\ 
    50 - 100 & 14 & 7\\ 
    100 - 150 & 21 & 19\\ 
...
\begin{frame}{Exercise answers}
  \begin{table}
    ...
    Bin & Data Count & Random Count & Percentage Difference \\
    \hline
    0 - 50 & 7 & 3 & 133\% \\ 
    50 - 100 & 14 & 7 & 100\%\\ 
    100 - 150 & 21 & 19 & 10.5\%\\ 
...
\begin{frame}{Redshift}
  \begin{block}{}
    \begin{itemize}
      \item{Why was it important that all the galaxies have the same redshift?}
    \end{itemize}
  \end{block}
\end{frame}
